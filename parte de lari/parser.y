%{ 
  ...
  #include <string.h>
  #include "clases.h"
  #include "revisaTag.h"/* contiene las estructuras y metodos de las funciones que se utilizan para construir el arbol e imprimirlo en consola */
